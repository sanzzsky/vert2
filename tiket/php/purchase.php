            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-4 border border-gray-100">
                        ...
                        <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-xl p-4 mb-6 text-white">
                            ...
                            <div class="space-y-1 text-sm">
                                <p><i class="fas fa-calendar-alt w-4 mr-2"></i><?php echo date('d F Y', strtotime($event['event_date'])); ?></p>
                                <?php if ($event['event_time']): ?><p><i class="fas fa-clock w-4 mr-2"></i><?php echo date('H:i', strtotime($event['event_time'])); ?> WIB</p><?php endif; ?>
                                <?php if ($event['location']): ?><p><i class="fas fa-map-marker-alt w-4 mr-2"></i><?php echo htmlspecialchars($event['location']); ?></p><?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-4 space-y-3">
                            <div class="flex justify-between text-gray-600"><span>Subtotal</span><span class="font-medium"><?php echo formatRupiah($subtotal); ?></span></div>
                            ...
                            <div class="border-t border-gray-200 pt-3 mt-2"><div class="flex justify-between items-center"><span class="text-lg font-bold text-gray-800">Total Pembayaran</span><span class="text-2xl font-bold text-primary"><?php echo formatRupiah($total_price); ?></span></div></div>
                        </div>
                ...
                <div class="lg:col-span-3 order-2 lg:order-1">
                    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <select name="id_type" required class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-primary focus:ring-4 focus:ring-primary/20"><option value="">Pilih jenis identitas</option><option value="KTP">KTP</option><option value="SIM">SIM</option><option value="Passport">Passport</option></select>
                                </div>
                                <div class="space-y-2">
                        ...
                        <div class="mt-8">
                            <button type="submit" id="submitBtn" class="w-full bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-[0.98] shadow-lg"><div class="flex items-center justify-center space-x-3"><i class="fas fa-credit-card text-lg"></i><span class="text-lg">Lanjut ke Pembayaran</span></div></button>
                        </div>
                        <input type="hidden" name="event_id" value="<?php echo $event_id; ?>"><input type="hidden" name="ticket_type_name" value="<?php echo htmlspecialchars($ticket_type_name); ?>"><input type="hidden" name="quantity" value="<?php echo $quantity; ?>"><input type="hidden" name="total_price" value="<?php echo $total_price; ?>">
                    </div>
                </div>
            </div>
        </form>
