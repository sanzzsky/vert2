        ...
        <form action="" method="GET" class="w-full sm:w-2/3 lg:w-1/2">
            <div class="relative">
                <input type="text" name="search" placeholder="Cari berdasarkan nama atau kategori event..."
                       class="w-full px-6 py-3 pr-12 rounded-xl shadow-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 transition bg-white"
                       value="<?= htmlspecialchars($searchQuery) ?>">
                <button type="submit" class="absolute inset-y-0 right-0 flex items-center px-4 text-gray-500 hover:text-purple-600">
    ...
    <main class="px-4 sm:px-6 md:px-12">
        ...
        <div class="flex flex-wrap justify-center gap-6 px-6 py-6">
            <?php if (count($tickets) > 0): ?>
                ...
                ?>
                <div class="w-64 h-[380px] bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col transform hover:-translate-y-2 transition-transform duration-300">
